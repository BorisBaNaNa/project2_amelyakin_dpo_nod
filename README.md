...
git git@github.com:BorisBaNaNa/project2_amelyakin_dpo_nod.git
cd project2_amelyakin_dpo_nod
...
>>>Введите команду: insert into users values ("Anton", 37, true)
...
# Выборка с условием
>>>Введите команду: select from users where age = 37
+----+--------+-----+-----------+
| ID |  name  | age | is_active |
+----+--------+-----+-----------+
| 1  | Anton   | 37  |    True   |
...
# Обновление записи
>>>Введите команду: update users set age = 38 where name = "Anton"
...
```bash
>>>Введите команду: insert into users values ("Ivan", 21, true)
...
[![asciicast](https://asciinema.org/a/aUhhyGcLv7W4q4oY.svg)](https://asciinema.org/a/aUhhyGcLv7W4q4oY)
...
Amelyakin Boris <superboris2001@yandex.ru>
